...
HOMEIMAGES = '/media/cecilia/DATA/cecilia/labelme/images'; % you can set here your default folder
HOMEANNOTATIONS = '/media/cecilia/DATA/cecilia/labelme/annotation'; % you can set here your default folder
...
[D_user,j_user] = LMquery(D, 'object.polygon.username', 'atb');
LMdbshowscenes(D, HOMEIMAGES); % this shows all the objects annotated by one user

% look for objects by viewpoint:
[D_view,j_view] = LMquery(D, 'object.viewpoint.azimuth', '0', 'exact');
